package com.c.cpayid.feature.menuUtama.PajakPBB;
...
public class ProdukPajakPBB extends BaseActivity implements ModalPajak.BottomSheetListenerProduksms {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Objects.requireNonNull(getSupportActionBar()).setTitle(Html.fromHtml("<font color='" + color2 +"'><b>Pajak PBB <b></font>"));
    ...
    public void settingLayout() {
        ...
        tujukarakterpajak.setTextColor(ColorMap.getColor(ApplicationVariable.applicationId, "green"));
    }
