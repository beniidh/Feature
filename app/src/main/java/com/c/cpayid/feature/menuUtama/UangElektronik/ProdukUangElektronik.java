package com.c.cpayid.feature.menuUtama.UangElektronik;
...
public class ProdukUangElektronik extends BaseActivity implements ModalUangElektronik.BottomSheetListenerProduksms {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Objects.requireNonNull(getSupportActionBar()).setTitle(Html.fromHtml("<font color='" + color2 +"'><b>Uang Elektronik <b></font>"));
        ...
        inputprodukuangelektronik.setOnClickListener(v -> {
    ...
    public void settingLayout() {
        ...
        tujukarakteruangelektronik.setTextColor(ColorMap.getColor(ApplicationVariable.applicationId, "green"));
    }
    ...
    public void getProduk(String id, String nomor) {
        ...
        call.enqueue(new Callback<ResponProdukUE>() {
            @Override
            public void onResponse(@NonNull Call<ResponProdukUE> call, @NonNull Response<ResponProdukUE> response) {
            ...
            @Override
            public void onFailure(@NonNull Call<ResponProdukUE> call, @NonNull Throwable t) {
