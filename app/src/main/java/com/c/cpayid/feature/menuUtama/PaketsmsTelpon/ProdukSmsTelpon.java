...
public class ProdukSmsTelpon extends BaseActivity implements ModalProdukSmsTelpon.BottomSheetListenerProduksms {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Objects.requireNonNull(getSupportActionBar()).setTitle(Html.fromHtml("<font color='" + color2 +"'><b>SMS & Telpon <b></font>"));
    ...
    public void settingLayout() {
        ...
        tujukaraktersmspulsa.setTextColor(ColorMap.getColor(ApplicationVariable.applicationId, "green"));
    }
